...
(* shifts for expressions of the form Shift(deltaX, deltaY, exp *)
...
fun preprocess_prog e =
	 case e of
      ...
      | LineSegment (x1, y1, x2, y2)  => if real_close_point (x1, y1) (x2, y2)
										 then Point(x1, y1)
										 else if x1 - x2 > epsilon orelse real_close(x1, x2) andalso y1 - y2 > epsilon
