...
fun month_range (day1 : int, day2 : int) =
	let 
		fun get_days (m : int, days_in_month : int list) = 
			if m = 1
			then hd days_in_month
			else get_days(m - 1, tl days_in_month)
	in 
		if day1 >= day2 orelse (what_month(day1) = 12 andalso what_month(day2) = 12)
		then what_month(day2) :: []
		else what_month(day1) :: month_range(day1 + get_days(what_month(day1), days_in_month), day2)
	end
